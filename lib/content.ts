...
export const independentWork: Role[] = [
  ...
  },
  {
    ...
    detail:
      "Independently developed systems — an operations Control Tower for EPC material work, a security and repository-assessment tool (Sentinel OS), a privacy-conscious education concept, and inventory prototypes — organized under a shared development and governance workspace.",
  },
  {
    period: "Ongoing",
